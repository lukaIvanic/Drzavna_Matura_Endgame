...
public class adminActivity extends AppCompatActivity {
    ...
    EditText netocanOdgEt4;
    EditText netocanOdgEt5;
    EditText netocanOdgEt6;
    EditText netocanOdgEt7;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        netocanOdgEt4 = findViewById(R.id.netocanOdgET4);
        netocanOdgEt5 = findViewById(R.id.netocanOdgET5);
        netocanOdgEt6 = findViewById(R.id.netocanOdgET6);
        netocanOdgEt7 = findViewById(R.id.netocanOdgET7);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                netocniOdgovori.add(netocanOdgEt4.getText().toString());
                netocniOdgovori.add(netocanOdgEt5.getText().toString());
                netocniOdgovori.add(netocanOdgEt6.getText().toString());
                netocniOdgovori.add(netocanOdgEt7.getText().toString());
    ...
    public void deleteEditTexts(){
        ...
        netocanOdgEt4.setText("");
        netocanOdgEt5.setText("");
        netocanOdgEt6.setText("");
        netocanOdgEt7.setText("");
    }
