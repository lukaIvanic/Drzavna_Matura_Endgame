...
public class GameActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentLayout = findViewById(R.id.textviewCounter);
        timerTextView = findViewById(R.id.timerTV);
        pitanjeTextView = findViewById(R.id.pitanjeTextView);

        constraintLayout = findViewById(R.id.whole_layout_compete);
    ...
    public void newQuestion(int questionNumber) {
        ...
        buttons.get(colorRandoms[0]).setBackgroundResource(R.drawable.blue_compete_button);
        buttons.get(colorRandoms[1]).setBackgroundResource(R.drawable.purple_compete_button);
        buttons.get(colorRandoms[2]).setBackgroundResource(R.drawable.yellow_compete_button);
        buttons.get(colorRandoms[3]).setBackgroundResource(R.drawable.green_compete_button);
