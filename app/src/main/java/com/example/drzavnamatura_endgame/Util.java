...
public class Util {
    ...
    public static final int ISPITI_MATURE = 0;
    public static final int ISPITI_GRADIVA = 1;
    public static final int VRSTA_MATEMATIKA = 0;
    public static final int VRSTA_HRVATSKI = 1;
    public static final int VRSTA_ENGLESKI = 2;
